...
parser.add_argument('-tr', '--trajectory_table_name', type=str, required=False, default='trajectory', help='trajectory table name (default is trajectory)')
parser.add_argument('-po', '--point_table_name', type=str, required=False, default='point', help='point table name (default is point)')
...
def main():
    ...
    # trajectory_table = args.trajectory_table_name
    # point_table = args.point_table_name
